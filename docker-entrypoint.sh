...
if [ -e /var/www/html/"$WORDPRESS_SUBDIRECTORY"/index.php ] && [ -e /var/www/html/"$WORDPRESS_SUBDIRECTORY"/.htaccess ] && [ ! -e /var/www/html/index.php ] && [ ! -e /var/www/html/.htaccess ]; then
  sed -i -e "s|/wp-blog-header.php|/$WORDPRESS_SUBDIRECTORY/wp-blog-header.php|g" /var/www/html/"$WORDPRESS_SUBDIRECTORY"/index.php
  mv /var/www/html/"$WORDPRESS_SUBDIRECTORY"/.htaccess /var/www/html/.htaccess
  mv /var/www/html/"$WORDPRESS_SUBDIRECTORY"/index.php /var/www/html/index.php
fi
